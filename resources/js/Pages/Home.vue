          ...
          <div v-show="showContent" class="w-full flex flex-col items-center text-center">
            ...
            <h1 class="text-5xl md:text-7xl font-extrabold tracking-tight mb-12 leading-tight text-center drop-shadow-sm flex flex-col items-center">
              ...
              <span class="relative inline-block mt-1 z-10">
                <span class="absolute -inset-4 rounded-full bg-gradient-to-r from-blue-600 via-cyan-500 to-indigo-600 opacity-25 blur-2xl animate-pulse-slow -z-10 animation-delay-1000"></span>

                <span class="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-cyan-500 to-indigo-600 dark:from-blue-400 dark:via-cyan-300 dark:to-indigo-400">
                  Decideix el Millor!
                </span>
                
                <svg class="absolute -bottom-3 left-0 w-full h-4 text-blue-500/40 dark:text-blue-400/50 z-0" viewBox="0 0 300 16" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
